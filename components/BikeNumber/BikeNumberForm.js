...
import styles from './BikeNumberForm.module.scss';
...
const BikeNumberForm = ({ submitHandler, values, isLoading, linkHandler, newBikeHandler }) => {
  ...
  return (
    <motion.div {...routeAnimation} className={styles.bikeNumberFormWrapper}>
      <form onSubmit={onSubmitHandler}>
        <div className="col-12 col-md-9 p-0 m-0">
          <h1 className="text-md-center">Bike Insurance</h1>
          ...
          <div className={styles.links}>
            <p onClick={rolloverHandler}>I DON&apos;T REMEMBER MY VECHILE NUMBER</p>
